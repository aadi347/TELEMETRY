<div align="center">
  ...
  <br />
  <img src="public/Screenshot.png" alt="OrbitalX HUD Preview" width="100%"/>
</div>

## Overview
OrbitalX is a web-based aerospace dashboard designed to track the International Space Station in real-time. Instead of presenting raw numbers, this platform transforms complex telemetry data into a highly visual, futuristic Heads-Up Display (HUD) inspired by mission control centers. 
